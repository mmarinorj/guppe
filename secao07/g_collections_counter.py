...
lista = [1, 1, 1, 2, 2, 3, 3, 3, 3, 1, 1, 1, 1, 1, 5, 2, 2, 4, 4, 4, 5, 5, 5, 5, 3, 45, 45, 66, 66, 43, 34]

# Utilizando o Counter
res = Counter(lista)
print(type(res))
print(res)
# Counter({1: 8, 3: 5, 5: 5, 2: 4, 4: 3, 45: 2, 66: 2, 43: 1, 34: 1})
# Veja que, para cada elemento da lista, o Counter criou uma chave que é cada objeto da lista e colocou como valor
# a quantidade de ocorrências deste objeto.
