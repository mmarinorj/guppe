...
# Paths absolutos
print(os.path.exists('/home/marcelo/university'))  # False
print(os.path.exists('/home/marcelo/Imagens'))  # True
print(os.path.exists('/home/marcelo/Imagens/eu.jpg'))  # True
...
# Criando arquivos - Maneira mais correta
# os.mknod('arquivo-teste4.txt')
# os.mknod('/home/marcelo/university.txt')

# OBS: Se você estiver utilizando no Mac OS, pode haver um erro de PermissionError
# OBS2: Criando um arquivo via mknod() se o arquivo já existir teremos o erro FileExistsError
...
# Path Absoluto
# os.mkdir('/home/marcelo/templates')
...
# Diretórios
# os.rename('templates2', 'templates5')

# OBS: Se o diretório não existir teremos um FileNotFoundError
# OBS2: Se e diretório que queremos renomear não estiver vazio, teremos um OSError

# Arquivos
# os.rename('templates5/novo2/outro2/teste.txt', 'templates5/novo2/outro2/geek.txt')
#
# Renomear arquivos e diretórios

# Arquivos
# os.rename('geek.txt', 'xgeek.txt')
...
# OBS2: Caso o arquivo não exista, teremos o FileNotFoundError
# OBS3: Se você informar um diretório ao invés de um arquivo, teremos um IsADirectoryError
...
# OBS2: Se o diretório não existir teremos um FileNotFoundError
